...
class TestSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $rolando = Docente::create(['user_id' => User::factory()->create([
            'role' => 'teacher',
            'name' => 'Rolando',
        ...
        $sarmiento = Docente::create(['user_id' => User::factory()->create([
            'role' => 'teacher',
            'name' => 'sarmiento',
        ...
        $yesenia = Docente::create(['user_id' => User::factory()->create([
            'role' => 'teacher',
            'name' => 'Yesenia',
        ...
        $roxana = Docente::create(['user_id' => User::factory()->create([
            'role' => 'teacher',
            'name' => 'Roxana',
        ...
        $minion = Docente::create(['user_id' => User::factory()->create([
            'name' => 'Minion',
            'role' => 'teacher',
