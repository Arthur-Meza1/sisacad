<aside class="w-64 p-4 sticky top-20 h-full">
  <nav class="space-y-2 font-medium">
    <a href="{{ route('teacher.dashboard') }}" data-view="dashboard"
       class="nav-link flex items-center p-3 rounded-lg hover:bg-gray-100 {{ request()->routeIs('teacher.dashboard') ? 'active-link' : 'inactive-link' }}">
    ...
    <a href="{{ route('teacher.horario') }}" data-view="schedule"
