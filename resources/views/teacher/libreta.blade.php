      ...
      <div id="courseCardSelector" class="space-y-4">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
          @foreach($grupos as $grupo)
            <div
              onclick="handleCourseCardClick({{$grupo['id']}}, '{{$grupo['nombre']}} ({{$grupo['turno']}}) - {{ucfirst($grupo['tipo'])}}')"
              class="p-6 bg-gradient-to-br from-blue-400 to-blue-600 rounded-xl shadow-lg cursor-pointer hover:shadow-xl hover:scale-105 transition text-white">
