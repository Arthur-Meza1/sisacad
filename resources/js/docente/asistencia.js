...
function onSendAsistencia(e) {
  ...
  const laravelData = {
    _token: formData[0].value, alumnos: changedMap
  };
...
function borrarSesion() {
  if (!confirm("Estás seguro que quieres eliminar esta sesion?")) return;
...
globalThis.borrarSesion = borrarSesion;
globalThis.closeAsistenciaModal = closeAsistenciaModal;
